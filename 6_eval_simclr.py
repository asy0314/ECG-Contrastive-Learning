...
def main():
    ...
    if args.save == '':
        args.save = f'./outputs/seed_{args.seed}/simclr/{args.arch}/{args.mode}/{args.num_train_folds}_folds/{args.label_type}'
    ...
    if args.checkpoint:
        if os.path.isfile(args.checkpoint):
            ...
            state_dict = {'.'.join(k.split('.')[2:]): v for k, v in checkpoint["state_dict"].items() if k.startswith('encoder.features')}
